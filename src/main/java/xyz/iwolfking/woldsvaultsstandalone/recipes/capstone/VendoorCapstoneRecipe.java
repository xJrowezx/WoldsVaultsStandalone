...
public class VendoorCapstoneRecipe extends VanillaAnvilRecipe {
    ...
    public boolean onSimpleCraft(AnvilContext context) {
        ...
        if (primary.getItem() == ModItems.VAULT_CRYSTAL && secondary.getItem() == xyz.iwolfking.woldsvaultsstandalone.init.ModItems.VENDOOR_CAPSTONE) {
            ItemStack output = primary.copy();
            CrystalData crystal = CrystalData.read(output);
            VaultModifierRegistry.getOpt(WoldsVaults.id("vendoor_hunter")).ifPresent((modifier) -> {
