...
import xyz.iwolfking.woldsvaultsstandalone.items.AirMobilityItem;
import xyz.iwolfking.woldsvaultsstandalone.items.AltarResetItem;
import xyz.iwolfking.woldsvaultsstandalone.items.ExpertiseOrbItem;
import xyz.iwolfking.woldsvaultsstandalone.items.ToolModifierNullifyingItem;
import xyz.iwolfking.woldsvaultsstandalone.items.fruits.HastyPomegranteItem;
import xyz.iwolfking.woldsvaultsstandalone.items.fruits.PoltergeistPlum;
import xyz.iwolfking.woldsvaultsstandalone.items.fruits.WisdomFruitItem;
import xyz.iwolfking.woldsvaultsstandalone.items.gear.VaultBattleStaffItem;
import xyz.iwolfking.woldsvaultsstandalone.items.gear.VaultLootSackItem;
import xyz.iwolfking.woldsvaultsstandalone.items.gear.VaultPlushieItem;
import xyz.iwolfking.woldsvaultsstandalone.items.gear.VaultTridentItem;
import xyz.iwolfking.woldsvaultsstandalone.items.rings.*;
...
public class ModItems {
    ...
    static {
        CRYSTAL_SEAL_MONOLITH = new ItemVaultCrystalSeal(WoldsVaults.id("crystal_seal_monolith"));
        ...
        BATTLESTAFF =  new VaultBattleStaffItem(WoldsVaults.id("battlestaff"), (new Item.Properties()).tab(GEAR_GROUP).stacksTo(1));
        TRIDENT = new VaultTridentItem(WoldsVaults.id("trident"), (new Item.Properties()).tab(GEAR_GROUP).stacksTo(1));
        PLUSHIE = new VaultPlushieItem(WoldsVaults.id("plushie"), (new Item.Properties()).tab(GEAR_GROUP).stacksTo(1));
        LOOT_SACK = new VaultLootSackItem(WoldsVaults.id("loot_sack"), (new Item.Properties()).tab(GEAR_GROUP).stacksTo(1));
