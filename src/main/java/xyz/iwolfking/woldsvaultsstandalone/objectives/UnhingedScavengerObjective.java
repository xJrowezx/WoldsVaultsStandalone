...
import xyz.iwolfking.woldsvaultsstandalone.configs.UnhingedScavengerConfig;
...
public class UnhingedScavengerObjective extends ScavengerObjective {
    ...
    public static enum Config {
        DEFAULT(() -> {
            return xyz.iwolfking.woldsvaultsstandalone.init.ModConfigs.UNHINGED_SCAVENGER;
        }),
        DIVINE_PARADOX(() -> {
