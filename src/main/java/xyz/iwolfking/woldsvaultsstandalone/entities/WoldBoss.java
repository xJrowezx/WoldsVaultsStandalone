package xyz.iwolfking.woldsvaultsstandalone.entities;

import iskallia.vault.entity.VaultBoss;
import iskallia.vault.entity.ai.*;
import iskallia.vault.entity.entity.EternalEntity;
import xyz.iwolfking.woldsvaultsstandalone.init.ModSounds;
...
public class WoldBoss extends Zombie implements VaultBoss {
    ...
    public SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return xyz.iwolfking.woldsvaultsstandalone.init.ModSounds.WOLD_HURT;
    }
