package xyz.iwolfking.woldsvaults.api.gear.util;
...
import xyz.iwolfking.woldsvaults.mixin.the_vault.accessors.ModifierGearTierAccessor;
...
public class GearModifierRegistryHelper {
    ...
    private static void logInvalidModifierTier() {
        VaultMod.LOGGER.warn(INVALID_MODIFIER_TIER);
    }
