...
public class DragonFruitItem extends ItemVaultFruit {
    private static final Random rand = new Random();
    public DragonFruitItem(ResourceLocation id) {
        super(id, 9000);
    }
...
//                    if(mod.getId().equals(WoldsVaults.id("vexation"))) {
//                        hasVexation = true;
//                        break;
//                    }
//                }
...
//        if(ServerVaults.get(level).isPresent()) {
//            Vault vault = ServerVaults.get(level).get();
//            VaultModifier<?> vexationMod = VaultModifierRegistry.get(WoldsVaults.id("vexation"));
//            if(vexationMod != null) {
//                VaultModifierUtils.sendModifierAddedMessage(sPlayer, vexationMod, 1);
//                vault.get(Vault.MODIFIERS).addModifier(VaultModifierRegistry.get(WoldsVaults.id("vexation")), 1, true, ChunkRandom.any());
//            }
//
//        }
//    }
