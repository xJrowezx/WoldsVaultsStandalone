...
public class DeckCoreTargetAttribute extends StringListAttribute {
    public DeckCoreTargetAttribute(String value) {
        super(value);
    }
    ...
    public List<String> getValues(ItemStack itemStack) {
        return DeckCoreFilterHelper.getTargets(itemStack);
    }

    @Override
    public String getNBTKey() {
        return "deck_core_target";
    }
}
